...
1.5 You may watch video of "Demonstration_of_Authentication & Encrypted Login Processes_API_Mini_Project_Login_CRUD_023-03-10-180613.mp4" (https://youtu.be/JiOhTotg-P0) for further reference on how to operate the backend file of app.js by opening the webpage of `localhost:10889` on the browser.
...
2.3 The operation in details can watch the video of "Demonstration_of_Authentication & Encrypted Login Processes_API_Mini_Project_Login_CRUD_023-03-10-180613.mp4" for further reference.
...
3.2. You operate CRUD intem of GET, POST, PUT and DELETE processess through POSTMAN to manage the movie records in the mongoDatabase one by one. The operation in details can watch the attached video of "Demonstration_of_MongoDB_API_Mini_Project_Movie_CRUD_023-03-10-180613.mp4" (https://youtu.be/RJzwXLdnj_0).
...
The operation in details can watch the attached video of "Demonstration_of_SQLite3_API_Mini_Project_Movie_CRUD_023-03-10-180613.mp4" (https://youtu.be/uUOYJMKGhCk).
